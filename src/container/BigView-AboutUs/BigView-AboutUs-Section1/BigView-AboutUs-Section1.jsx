    ...
    render() {
        return (
            <div id="BigViewAboutUs-Section1">
                <div className="BigViewAboutUs-Section1-Parent-Container">
                    <div className="BigViewAboutUs-Section1-Content-Container">
                        <img data-aos="fade-down-left" data-aos-offset="200" data-aos-delay="0" className="BigViewAboutUs-Section1-Background" src={require("../../../src/Big-View/BigView-AboutUs/Section1-Background.png")} alt="" />
                        <h1 data-aos="fade-down-right" data-aos-offset="200" data-aos-delay="100" className="BigViewAboutUs-Section1-Title">
                            About Us
                        </h1>
                        <p data-aos="fade-down-right" data-aos-offset="200" data-aos-delay="200" className="BigViewAboutUs-Section1-Desc1">
                        ...
                        <p data-aos="fade-down-right" data-aos-offset="200" data-aos-delay="300" className="BigViewAboutUs-Section1-Desc2">
