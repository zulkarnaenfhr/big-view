        ...
        return (
            <div id="BigViewLandingPage-Section8">
                ...
                <div className="BigViewLandingPage-Section8-Card-Container">
                    ...
                    <img data-aos="fade-right" data-aos-delay="100" src={require("../../../src/Big-View/BigView Arrow.png")} className="BigViewLandingPage-Section8-Card-Arrow BigViewLandingPage-Section8-Card-Arrow1" alt="" />
                    ...
                    <img data-aos="fade-right" data-aos-delay="300" src={require("../../../src/Big-View/BigView Arrow.png")} className="BigViewLandingPage-Section8-Card-Arrow BigViewLandingPage-Section8-Card-Arrow2" alt="" />
